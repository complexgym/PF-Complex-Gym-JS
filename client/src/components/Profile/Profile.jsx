		...
		<div className='profile-page'>
			...
			<section className='relative py-16 bg-blueGray-200'>
						...
						<div className='px-6'>
							...
							<div className='text-center mt-12'>
								...
								<div className='text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase'>
									...
									{`${matchEmail.city}, ${matchEmail.regioon}`}
								</div>
				...
				<div className='flex justify-center'>
					<Link to="/home" className='bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 ease-linear transition-all duration-150 w-24 text-center'>Volver</Link>
				</div>
			</section>
