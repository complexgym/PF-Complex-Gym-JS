			...
			<div className='flex justify-center testimonials-container'>
				<section className='reviews 2xl:mt-20 xl:mt-10 lg:mt-20 md:mt-16 xs:mt-12'>
					...
					<div className='flex flex-wrap place-content-center'>
						<button
							className=' mt-10 inline-flex justify-center rounded-md bg-lighter-blue py-2 px-3 text-lg font-semibold text-white shadow-sm hover:bg-darker-blue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-vlighter-blue'
							type='button'
							onClick={handleSend}
						>
							Deja tu opnión
