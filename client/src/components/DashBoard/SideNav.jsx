...
import icono_menu from '../../assets/img/menu-black.png';
...
const SideNav = () => {
	...
	return (
		<>
			...
			<aside
				className=' hidden fixed  inset-y-0 flex-wrap items-center justify-between xl:block  2xl:block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0 '
				aria-expanded='false'
			>
				<div className='h-19'>
					<i
					...
					>
						<div className='flex relative justify-center '>
							<Link
								to='/home'
								className='bg-lighter-blue uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 ease-linear transition-all duration-150 w-24 text-center'
							>
								Volver
							</Link>
						</div>
			...
			<div className='relative w-screen h-auto  bg-[#fdfdfd] 2xl:hidden xl:hidden '>
				<div className='h-19'>
					<div className='w-screen h-[100%] relative'>
						...
						<div className='flex absolute top-1/2 transform -translate-y-1/2 left-8'>
							<Link
								to='/home'
								className='bg-lighter-blue uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 ease-linear transition-all duration-150 w-24 text-center'
							>
				...
				<div className={!open ? '' : 'hidden'}>
					<div className='flex  w-[50vw] h-auto py-5 bg-[#fefefe] '>
						<ul className='flex flex-col pl-0 mb-0'>
							<li className='mt-0.5 w-full'>
								<a
									className={`${
