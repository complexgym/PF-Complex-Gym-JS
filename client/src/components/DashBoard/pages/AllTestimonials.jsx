...
const AllTestimonials = () => {
	...
	return (
		<div>
			<body className='m-0 font-sans text-base antialiased font-normal dark:bg-slate-900 leading-default bg-gray-50 text-light-gray'>
				<div className='absolute w-full h-full bg-light-gray dark:hidden min-h-75'></div>
