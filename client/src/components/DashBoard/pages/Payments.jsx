...
const Payments = () => {
	...
	const { allPayments, initial_plans, allClients, actual_plan } = useSelector((s) => s);
								...
								>
									...
									<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center'>
										...
										<div className='w-full'>
											<button
												type='submit'
												className='inline-block ml-4 w-full md:w-32 h-12 py-2 px-4 mb-0 font-bold text-white capitalize shadow-sm fill-current bg-lighter-blue rounded-xl relative right-4 md:right-0 mt-8'
											>
												Crear pago
											</button>
										</div>
