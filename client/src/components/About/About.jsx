	...
	return (
		...
		<div className='2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4'>
			<div className='flex flex-col lg:flex-row justify-between gap-8'>
				{/* Seccion 1 */}
				<div className='w-full lg:w-5/12 flex flex-col justify-center pt-28 col-span-2'>
				...
				<div className='max-h-[850px] lg:w-8/12'>
					<img
						className=''
			...
			<div className='flex lg:flex-row flex-col justify-end gap-8 pt-12'>
				...
				{/* Mobile */}
				<div className='w-full h-[400px] lg:w-8/12 block lg:hidden'>
					<img
						className='w-full '
						src='https://res.cloudinary.com/dpxucxgwg/image/upload/v1679073922/IMG-20230301-WA0052_ouc60i.jpg'
						alt='A group of People'
			...
			<div className='2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4'>
				<div className='flex flex-col lg:flex-row justify-between gap-8'>
					<div className='w-full lg:w-5/12 flex flex-col justify-center'>
						...
						<p className='font-normal text-base leading-6 text-gray-600 '>
							En complex todos son bienvenidos, no hace falta tener experiencia o saber
							cómo realizar los ejercicios. Acá dentro siempre va a haber un guía
							esperando ayudarte.
						</p>
					</div>
					{/* Desktop */}
					...
					{/* Mobile */}
					<div className='w-full h-[300px] lg:w-8/12 block lg:hidden'>
						<img
							className='w-full '
							src='https://res.cloudinary.com/dpxucxgwg/image/upload/v1679014951/IMG-20221214-WA0013_em9erm.jpg'
							alt='A group of People'
				...
				<div className='flex lg:flex-row flex-col justify-end gap-8'>
					...
					<div className='lg:w-5/12 flex flex-col justify-center text-left w-screen'>
						...
						<p className='font-normal text-base leading-6 text-black'>
							<h1>Agustín:</h1>
							Profesor de Educación física, entrenador, masoterapeuta, antropometrista y
							deportista.
						</p>
						<h1>Julieta:</h1>
					...
					{/* Mobile */}
					<div className='w-full h-[200px] lg:w-8/12 block lg:hidden'>
						<img
							className='w-full '
							src='https://res.cloudinary.com/dpxucxgwg/image/upload/v1679014951/IMG-20221214-WA0013_em9erm.jpg'
							alt='A group of People'
